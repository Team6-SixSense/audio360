...
\begin{itemize}
    ...
    \item \label{SR7}\textbf{SR7:} The system shall continuously monitor the
    thermal temperature of all hardware components.

    \item \label{SR8}\textbf{SR8:} The system shall initiate thermal mitigation
    measures when thermal temperatures exceed user safe and hardward safe
    thresholds.

    \item \label{SR9}\textbf{SR9:} The system shall have
    ...
    \item \label{SR10}\textbf{SR10:} The system shall notify users when a sound 
    classification result has low confidence or is unrecognized to prevent 
    misleading contextual feedback.

    \item \label{SR11}\textbf{SR11:} The system shall estimate the
    ...
    \item \label{SR12}\textbf{SR12:} The system shall perform continuous
...
\begin{itemize}
    ...
    \item \hyperref[SR12]{SR12}
\end{itemize}

The following safety and security requirements are considered out of scope 
for this capstone project due to hardware limitations and the current technical 
