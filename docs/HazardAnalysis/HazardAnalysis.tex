...
\begin{tabular}{ll}
\toprule
\textbf{Safety Requirement} & \textbf{Requirement from SRS} \\
\midrule
\hyperref[SR1]{SR1} & \hyperref[SRS-FR9_1]{FR9.1} \\
\hyperref[SR2]{SR2} & \hyperref[SRS-NFR4_3]{FR4.3} \\
\hyperref[SR3]{SR3} & \hyperref[SRS-FR3_5]{FR3.5} \\
\hyperref[SR4]{SR4} & \hyperref[SRS-FR4_4]{FR4.4} \\
\hyperref[SR5]{SR5} & \hyperref[SRS-NFR6_2]{NFR6.2} \\
\hyperref[SR6]{SR6} & \hyperref[SRS-FR6_2]{FR6.2} \\
\hyperref[SR7]{SR7} & \hyperref[SRS-NFR3_3]{FR3.3} \\
\hyperref[SR8]{SR8} & \hyperref[SRS-FR5_4]{FR5.4} \\
\hyperref[SR9]{SR9} & \hyperref[SRS-NFR5_3]{NFR5.3} \\
\hyperref[SR10]{SR10} & \hyperref[SRS-FR1_4]{FR1.4} \\
\bottomrule
\end{tabular}
\caption{Safety requirements traceability to SRS requirements.}
\end{table}
