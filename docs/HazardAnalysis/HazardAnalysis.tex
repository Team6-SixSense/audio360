...
\externaldocument[SRS-]{../SRS/SRS}[../SRS/SRS.pdf]
...
\begin{enumerate}
    \item Microphone
    \begin{itemize}
        \item All microphones are able to capture frequencies between at least 0 to 20kHz, which is the human sound detectable range (\ref{SRS-def:normal_operation_condition}).
