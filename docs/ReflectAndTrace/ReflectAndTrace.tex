...
write up of the design document. Thus, table \ref{tab:doc-feedback-tracking}
outlines the feedback in regards to the design document.

\label{tab:doc-feedback-tracking}
\begin{longtable}{|p{2cm}|p{4.5cm}|p{3.5cm}|p{3cm}|}
    \hline
    \textbf{Feedback Source} & \textbf{Feedback Summary} & \textbf{Changes Made}
    & \textbf{Related \newline Commits/Issues} \\
    ...
    Sample & Sample & Sample & \href{Sample}{Issue \#1} \\
    \hline

    \caption{Design Documentation Feedback Tracking and 
        Implementation}
\end{longtable}
