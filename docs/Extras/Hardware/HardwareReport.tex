...
\ref{fig:final_product}. The PCB is mounted directly onto a 3D printed frame,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{diagrams/final_product.png}
    \caption{Final hardware product.}
