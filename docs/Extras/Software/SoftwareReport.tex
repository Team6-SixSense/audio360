...
because it provides a comprehensive overview of how PyRoomAcoustics was leveraged 
...
The structure of the document is as follows. Section~\ref{sec:doa} covers the 
...
PyRoomAcoustics simulation workflow. Section~\ref{sec:classification} discusses 
...
combination of publicly available sound libraries like FSD50k 
