...
\begin{itemize}
  ...
  \item System Specialist (Omar Alam)
    \begin{itemize}
      ...
      \$500.
      \item Technical Role: Embedded Hardware and Software Developer - 
      responsible for the development of the hardware platform and the interface 
      between the hardware and the software on the microcontroller.
    \end{itemize}
\end{itemize}
