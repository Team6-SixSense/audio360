...
If the PoC were to be unsuccessful, the team will narrow down the scope of the
project and re-evaluate the project scope and goals. The scope would most likely
be narrowed down to the funcational parts of the PoC, with future revisions only
including extensions to those functional components.
