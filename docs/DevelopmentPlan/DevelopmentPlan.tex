...
\begin{itemize}
  ...
  \item Reviewer (Jay Sharma)
    \begin{itemize}
      \item Reviews all deliverables before submission to ensure all sections are completed.
      \item Reach out to the reviewers of each section to ensure they approve it before telling the team leader to submit it.
    \end{itemize}
  \item Note taker (Nirmal Chaudhari)
    \begin{itemize}
      \item Takes notes during meetings.
      \item Ensures each meeting issue contains meeting notes.
      \item Closes meetiing issues after meeting is completed, with a comment 
    \end{itemize}
