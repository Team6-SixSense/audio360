...
\item[\refstepcounter{acnum} \actheacnum \label{NumClassification}:]
  ...
  \textbf{Rationale:} \hyperref[SRS-NFR5_1]{NFR5.1} specifies atleast 3 distinct
...
\item [\refstepcounter{mnum} \mthemnum \label{mFaultManager}:] Software Fault 
Manager Module 
...
peripherals and clocks required for SD card communication. Thi module also 
...
\item[Secrets:] The method used to route character streams to output sources,
  and the internal log formatting strategy, including timestamping and file
  source information.
