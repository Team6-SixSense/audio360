...
2026-01-06 & 2.0 & Module type definitions \& formatting section Module
                   Decomposition.\\
2025-01-06 & 1.0 & Detailed timeline Rev0. \\
\bottomrule
\end{tabularx}
...
verification with the hardware while respecting module dependencies.

\begin{table}[H]
    \centering
    \begin{tabular}{|c|c|}
        \hline
        \textbf{Module} & \textbf{Deadline} \\ \hline
...
integration testing. Omar Alam and Sathurshan Arulmohan will be taking main
