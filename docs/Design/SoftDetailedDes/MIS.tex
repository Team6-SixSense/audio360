...
\section{MIS of Audio Sampling Module \label{MAudioSampling} -
...
\section{MIS of Audio Spectral Leakage Prevention Module
  \label{MAudioSpectralLeakage} - \mref{MG-mAudioSpectralLeakage}}
...
\section{MIS of Audio Normalizer Module \label{MAudioNormalizer} -
...
\newpage
\section{MIS of Fast Fourier Transform - \mref{MG-mFFT}} \label{MFFT}
...
\begin{itemize}
  \item \hyperref[MAudioSpectralLeakage]{Audio Spectral Leakage Prevention
    Module}
\end{itemize}
...
\section{MIS of Logging Module \label{MLogging} -
  \mref{MG-mLogging}}
...
\section{MIS of Mel Filter Module \label{mMelFilter} - 
\mref{MG-mMelFilter}}
...
\section{MIS of Discrete Cosine Transform Module \label{mDCT} - 
\mref{MG-mDCT}}
...
\section{MIS of Principle Component Analysis Module \label{mPCA} - 
\mref{MG-mPCA}}
...
\section{MIS of Linear Discriminant Analysis Module \label{mLDA} - 
\mref{MG-mLDA}}
...
TODO: refine and add hyperlinks
\begin{enumerate}
  \item Audio classification
  \item Directional Analysis
  \item Visualization controller 
  \item ...
\end{enumerate}
