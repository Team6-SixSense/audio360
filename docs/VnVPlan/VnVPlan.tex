...
\begin{itemize}
\item Classification accuracy $\geq$ 90\% per class
...
\begin{itemize}
\item Classification accuracy $\geq$ 90\% per audio class
\item Tested across all supported audio classes (car horn, kettle, alarm, speech, etc.)
\end{itemize}
