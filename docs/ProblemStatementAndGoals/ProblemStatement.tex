...
These individuals will be the end-users of the system and will benefit from the
system's ability to provide them with a visual indication of the direction of
audio sources and their respective classifications.

The secondary stakeholders are family members and caregivers of individuals who
are deaf or hard of hearing. These individuals will benefit from the system's
ability to provide them with a visual indication of the direction of audio
sources and their respective classifications.

The tertiary stakeholders are employers and workplace safety officers. These
individuals will benefit from the system's ability to provide them with a visual
indication of the direction of audio sources and their respective 
classifications.

\subsection{Environment}

The software environment is a real-time operating system. 
The hardware environment is a 4 dimentional microphone
array, with each microphone connected to a microcontroller for
processing, as well as a pair of smart glasses for the
visual display.

\section{Goals}

\begin{itemize}
    \item Capture real-time audio from a set of microphones.
    \item Syncronize a set of incoming audio sources.
    \item Estimate direction of arrival (DoA) for single sound sources, 
    providing reliable localization for practical use cases.
    \item The system should be easy to use, with a user-friendly
    interface (easy to interpret output) and no setup required.
    \item The system should be comfortable to wear for extended periods of time,
    with minimal discomfort or fatigue.
\end{itemize}
\section{Stretch Goals}

\begin{itemize}
    \item Classify sounds using audio fingerprinting with high accuracy,
    allowing the system to recognize and differentiate between common sounds.
    \item Display audio classification and transcription on smart glasses with,
