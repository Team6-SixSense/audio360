...
2025-12-12 & Omar & Address TA feedback.\\
\bottomrule
\end{tabularx}
\end{table}
...
audio sources and what the identified source of a sound is (e.g. car horn, 
dog bark).
...
\\[\baselineskip]
Secondary stakeholders identified include noise cancelling headphone users and
construction workers. The brain exploits how the human ear shape changes
waveforms hitting the eardrum from various directions to localize sound direction.
Placing noise cancelling headphones severely degrades the brain's ability
to localize sound in addition to very little sound being transmitted through 
noise cancelling headphones. The same reasoning applies for construction workers
who have to wear large ear muffs to protect their hearing \cite{HIL_HearingCues}. 
\\[\baselineskip]
