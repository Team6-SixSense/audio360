...
\begin{itemize}
    ...
    error for single sound sources, providing reliable localization for
    practical use cases.
\end{itemize}
...
\begin{itemize}
    ...
    \item Display audio classification and transcription on smart glasses with a
    latency of <= 1s, supporting real-time, user-friendly interaction.
\end{itemize}
\section{Extras}
