...
All project staff have responsibilities they need must carry out in addition to individual work required for deliverables. 
The roles, qualifications for the role and their assignment are outlined below. 
...
Moreover, each project member has been designated as an \textbf{expert} in a specific area of research essential to the development of this system. 
The designated research areas are outlined below:

\begin{itemize}\setlength\itemsep{4pt}\setlength{\leftmargini}{2em}
    \item Investigation of compatible libraries supporting Fast Fourier Transform (FFT) operations for the selected microcontroller \textbf{(Sathurshan Arulmohan)}.
    \item Evaluation and selection of a suitable microcontroller for system implementation \textbf{(Omar Alam)}.
    \item Analysis of methods to extract directionality from a microphone array \textbf{(Kalp Shah)}.
    \item Exploration of techniques for separating multiple audio sources from a single microphone input using Independent Component Analysis (ICA) \textbf{(Jay Sharma)}.
    \item Development of heuristic-based approaches for classifying different sounds through audio fingerprinting \textbf{(Nirmal Chaudhari)}.
\end{itemize}

\noindent
All experts share the following responsibilities for their area of research. 
...
To better understand the needs of our stakeholders, there are various milestones that need to be completed within the realm of elicitation and documentation in the 
requirements engineering process. These milestones can be generalized as a list of tasks, with their deadlines outlined below.

\begin{enumerate}
  \item Initial Supervisor Consultation (mvm) (2025-09-15)
  ...
  \item Extraction of requirements from goals and technical assessment (2025-10-2)
  \item Requirements Documentation (2025-10-10)
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{itemize}\setlength\itemsep{2pt}
      ...
      \item Supervisor confirms feasibility of the project, and vision for the POC. 
      \item Defined list of research priorities (outlined in section P.1).
      \item Establish communication methods and frequency for supervisor check-ins. 
  \end{itemize}
  ...
  \textbf{Tasks:}
  \begin{itemize}\setlength\itemsep{2pt}
      \item Based on supervisor consultation, brainstorm and document list of soft goals. 
  ...
  \item \textbf{Technical analysis for feasibility of project goals (2025-09-29)}  
  ...
  \item \textbf{Extraction of requirements from goals and technical assessment (2025-10-2)}  
  ...
  \textbf{Tasks:}
  \begin{itemize}\setlength\itemsep{2pt}
      \item Iteratively updating sections in SRS document based on the results of different tasks mentioned in P.3. 
  \end{itemize}
