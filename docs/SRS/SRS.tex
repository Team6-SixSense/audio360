...
\begin{itemize}
  ...
  \item \label{FR4_5}\textbf{FR4.5:} The Audio360 Engine shall portable. That is
  the system can be deployed on different hardware. This is to ensure that the
  there is flexibility to upgrade hardware to meet higher processing demands
  when needed.
\end{itemize}
