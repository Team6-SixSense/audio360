...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Consult with the technical supervisor of this application (MVM~\ref{itm:domain-experts}) to gain insight into what approaches can be used. 
    \end{enumerate}
...
As this project follows the V-model methodology, the team will aim to make the various stages of the requirements process mentioned above
linear. Since although this model allows the team to re-visit previous parts, it will cost a lot to change in later stages of the project. 
This is why this team is heavily prioritizing the initial stages of the requirements process. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{./images/v_model.png}
...
=======
\newpage
>>>>>>> a796262 (fix[doc] - issue#126: Addressing requirement process feedback)
