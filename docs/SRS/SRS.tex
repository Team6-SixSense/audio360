...
\begin{longtable}{|l|l|p{10cm}|}
    ...
    \hline
    $A_{classification}$ \label{symbol:A_classfication} & $90\%$ & 
    Classification accuracy. $90\%$ is chosen as it an achievable metric
...
\begin{itemize}
  ...
  While state of the art audio classification systems can reach up to 90\%
