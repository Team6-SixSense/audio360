...
\begin{itemize}
  ...
  priority. For example, if frame $F_t$ arrives at time $t$, then the priority,
  $P(F_t)$, must satisfy $P(F_t) > P(F_{t+1})$.
  ...
  \hyperref[NFR7_1]{NFR7.1}. This ensures that all input data from the
  microphone can be processed.

  \item \label{NFR4_3}\textbf{NFR1.3:} The firmware shall permanently
