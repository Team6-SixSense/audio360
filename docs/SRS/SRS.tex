...
200 MHz. This constraint is imposed to ensure that the audio processing tasks
defined in functional requirement \href{NFR1_3}{NFR1.3} can be
...
\textbf{Microphones:}  
The system shall use between two and four microphones to collect audio data
from the environment. This range of microphones enables directional detection
while minimizing hardware complexity, cost, and power consumption.

\textbf{Programming Languages:}  
The embedded firmware shall be implemented in C/C++. This choice is imposed
because compiled C/C++ binaries can be directly executed on the microcontroller,
and the language provides low level access to system resources, memory, and
hardware acceleration functions necessary for efficient signal processing.
...
An analog to digital converter is required between each the microphone and
...
A visual display module to show processed information to users who are hard of
hearing.
