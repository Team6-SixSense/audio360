...
to avoid external malicious acts.
...
\begin{itemize}
  ...
  powers of 2 and size up to 4096 frames. Powers of 2 since 
  hardware acceleration, from \hyperref[FR3_4]{FR3.4}, for FFT are most
  optimized for this \cite{CMSIS_DSP_FFT}. 4096 frame is the maximum standard
  size.

  \item \label{NFR3_3}\textbf{NFR3.3:} The audio filtering component shall have
  an audio processing success rate end to end of 100\%. All user core features
  depends on this component, thus, it must work every time.
\end{itemize}
...
\begin{itemize}
  ...
  \hyperref[symbol:theta_e]{$\theta_e$} degrees.
...
microcontroller will be used for ease of development, regardless if it can be
