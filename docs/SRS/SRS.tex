...
\begin{itemize}\setlength\itemsep{4pt}\setlength{\leftmargini}{2em}
    ...
    \item Analysis of methods to extract directionality from a microphone array,
     since we need to process input from 4 microphones
    ...
    \textbf{(Jay Sharma)}.
    \item Development of heuristic-based approaches for classifying different 
    sounds through audio fingerprinting. This focus area is needed
    to classify sounds without running a deep machine learning algorithm due to
     limited processing power. \textbf{(Nirmal Chaudhari)}.
\end{itemize}
...
\begin{itemize}\setlength\itemsep{4pt}\setlength{\leftmargini}{2em}
  ...
  \item Configure github pipeline to run those tests on every PR and merge into 
  a feature branch. 
\end{itemize}
...
To better understand the needs of our stakeholders, there are various milestones
...
\begin{enumerate}
  ...
  \begin{itemize}
      ...
      \item Defined list of research priorities 
      (outlined in section P.1\ref{item: p1}).
  \end{itemize}
  ...
  \begin{itemize}
      ...
      of different tasks mentioned in P.3(\ref{item: p3}). 
  \end{itemize}
  ...
  \begin{itemize}
      ...
      specification.
      This plan should be exhaustive enough to confirm that all our stakeholder 
      goals have been met. 
  \end{itemize}
  ...
  \item \textbf{Verification \& Validation of System 
  (2026-02-02)~\ref{item: p3-8}}  
  ...
  \textbf{Tasks:}
  \begin{itemize}
      \item Set up a meeting with the McMaster Sign Language club to conduct a
       semi-structured interview.
      \item Document all findings from interview specific to the questions we 
      asked. 
