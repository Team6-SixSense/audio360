...
\begin{itemize}
    ...
    hardware system with a CPU, memory, input/output peripherals, designed
...
\begin{itemize}
  ...
  by locking memory slots that are still being used when another component
  requests to write to it.

  \item \label{NFR2_2}\textbf{NFR2.2:} The driver shall immediately propagate
