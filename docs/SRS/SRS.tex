...
With over 4 million Canadians affected by hearing loss, there is a significant
need for assistive technologies that can improve situational awareness and 
safety.
...
Capture real-time audio data from a microphone array
...
to improve awareness of audio sources at various volumes. While this helps
individuals with partial hearing loss, it does not assist those who are
profoundly deaf, nor does it provide visual cues about sound direction or
classification.
...
as warning beeps from forklifts, tea kettles whistling, or car engines
...
from a synchronized 4-microphone array mounted on smart glasses, ensuring
...
\item \textbf{Network connectivity or cloud processing:} All processing will
...
situational awareness and safety. This group includes approximately 4
million Canadians (1 in 10) who experience hearing loss.
\end{itemize}
...
for STM32F767 microcontroller, FreeRTOS, FFTW library, Rokid Smart Glasses,
