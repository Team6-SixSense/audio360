...
\begin{itemize}
  ...
  \item \textbf{Audio Filtering:} \label{comp:signal_processing}
  Component responsible for processing raw audio signals in real-time sent
  by the microphones.

  \item \textbf{Calibration Component:} \label{comp:signal_processing}
  Component for calibrating on-board hardware, such as microphones.
  
  \item \textbf{Audio360 Engine:} \label{comp:program}
  ...
  output display \href{comp:display}.
\end{itemize}
