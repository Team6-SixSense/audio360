...
void main_sd_diag()
{
    ...
    int32_t waveform_buffer1[WAVEFORM_SAMPLES_SD];
    int32_t waveform_buffer2[WAVEFORM_SAMPLES_SD];
    int32_t waveform_buffer3[WAVEFORM_SAMPLES_SD];
    int32_t waveform_buffer4[WAVEFORM_SAMPLES_SD];
    ...
    while(1){
        for (int i = 0; i < WAVEFORM_SAMPLES_SD; i++) {
