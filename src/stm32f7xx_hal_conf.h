...
#define ETH_RX_BUF_SIZE                                                        \
  1528U /* ETH Max buffer size for receive               */
#define ETH_TX_BUF_SIZE                                                        \
  1528U                /* ETH Max buffer size for transmit              */
...
#define PHY_MICR                                                               \
  ((uint16_t)0x11U) /*!< MII Interrupt Control Register                  */
#define PHY_MISR                                                               \
  ((uint16_t)0x12U) /*!< MII Interrupt Status and Misc. Control Register */

#define PHY_LINK_STATUS                                                        \
  ((uint16_t)0x0001U) /*!< PHY Link mask                                   */
...
#define PHY_MICR_INT_EN                                                        \
  ((uint16_t)0x0002U) /*!< PHY Enable interrupts                           */
#define PHY_MICR_INT_OE                                                        \
  ((uint16_t)0x0001U) /*!< PHY Enable output interrupt events              */
