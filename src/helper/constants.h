...
inline std::vector<std::vector<float>> LDA_CLASS_WEIGHTS = {
    {0.00244932f, 0.00289053f, -0.0496956f, 0.4416219f, -0.10099409f,
     -0.00122701f, -0.03179949f, 0.42757362f, -0.54738826f, 0.13554996f,
     0.08970945f, 0.06134592f, 0.14315131f},
    {0.00914337f, -0.08740987f, -0.14868397f, 0.05945394f, -0.33550376f,
     -0.39169413f, -0.3331003f, 0.5991807f, 0.32246852f, -0.17314257f,
     -0.47377595f, -0.3176133f, 0.12600057f},
    {0.05105919f, -0.14867538f, 0.23933277f, 0.123431f, -0.01271244f,
     0.04056986f, -0.03312543f, -0.0879069f, 0.01699896f, -0.14475407f,
     -0.10233642f, -0.16339482f, 0.00786805f},
    {-0.04927337f, 0.14343104f, -0.20094599f, -0.26273552f, 0.06252164f,
     -0.01702504f, 0.05908675f, -0.0880561f, 0.14492807f, 0.10115039f,
     0.09207771f, 0.15043442f, -0.06059633f}};

inline std::vector<float> LDA_CLASS_BIASES = {-3.2379878, -6.2000546,
                                              -1.8167682, -1.7288511};

inline std::vector<std::string> CLASSIFICATION_CLASSES = {
    "car_horn", "clapping", "jackhammer", "siren"};