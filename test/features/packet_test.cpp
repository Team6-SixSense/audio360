...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(PacketParamType{ClassificationLabel::Unknown,
                      ...
                      PacketParamType{ClassificationLabel::Fire,
                                      DirectionLabel::North,
                                      SystemFaultState::HARDWARE_FAULT,
                                      {0xAA, 0x00, 0x01, 0x01, 0x0}},
                      PacketParamType{ClassificationLabel::Fire,
                                      DirectionLabel::West,
                                      SystemFaultState::CLASSIFICATION_FAULT,
                                      {0xAA, 0x00, 0x03, 0x02, 0x00}},
                      PacketParamType{
                          ClassificationLabel::Engine,
                          DirectionLabel::North,
                          SystemFaultState::DIRECTIONAL_ANALYSIS_FAULT,
                          {0xAA, 0x01, 0x01, 0x03, 0x00}},
                      PacketParamType{ClassificationLabel::TruckReversing,
                                      DirectionLabel::West,
                                      SystemFaultState::CLASSIFICATION_FAULT,
