...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(PacketParamType{ClassificationLabel::Unknown,
                      ...
                      PacketParamType{ClassificationLabel::Siren,
                                      DirectionLabel::North,
                                      SystemFaultState::HARDWARE_FAULT,
                                      {0xAA, 0x01, 0x01, 0x01, 0x0}},
                      PacketParamType{ClassificationLabel::Jackhammer,
                                      DirectionLabel::West,
                                      SystemFaultState::CLASSIFICATION_FAULT,
                                      {0xAA, 0x02, 0x03, 0x02, 0x00}},
                      PacketParamType{
                          ClassificationLabel::CarHorn,
                          DirectionLabel::North,
                          SystemFaultState::DIRECTIONAL_ANALYSIS_FAULT,
                          {0xAA, 0x03, 0x01, 0x03, 0x00}},
                      PacketParamType{ClassificationLabel::CarHorn,
                                      DirectionLabel::West,
                                      SystemFaultState::CLASSIFICATION_FAULT,
